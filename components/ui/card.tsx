...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("flex flex-col space-y-1.5 border-b border-zinc-200 px-6 py-4 dark:border-zinc-800", className)}
      {...props}
    />
  )
);
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("border-t border-zinc-200 px-6 py-4 dark:border-zinc-800", className)} {...props} />
  )
);
